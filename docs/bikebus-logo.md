...
- [Badge and text](#badge-and-text)
- [Text only](#text-only)
- [Tall text only](#tall-text-only)
- [Ribbon for Bike Bus medals](#ribbon-for-bike-bus-medals)
- [Medal design for Bike Bus medals](#medal-design-for-bike-bus-medals)
- [Badge only](#badge-only)
- [Badge and text on a curved baseline](#badge-and-text-on-a-curved-baseline)
